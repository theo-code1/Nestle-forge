...
const ConvertedImg = ({ convertedImage, ImageName, ImageSize, DownloadImg, imgHref, handleDelete, selectedImgDetails, isConverted, handleConverting, selectedImg, setConvertToFormat, convertToFormat, isLoading }) => {

  const formatCategories = {
    // Image: ["PNG", "JPEG", "WEBP", "BMP", "GIF", "ICO"],
    Image: ['png', 'jpg', 'jpeg', 'gif', 'bmp', 'webp', 'tiff', 'ico', 'jfif'],
  };
